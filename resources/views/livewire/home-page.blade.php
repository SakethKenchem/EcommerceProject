<div>
    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Welcome to the one-stop shop <span class="text-blue-600">ECommerce</span></h1>
          <p class="mt-3 text-lg text-gray-800 dark:text-neutral-400">Browse your favorite products and make that purchase you always wanted to!</p>
          ...
          <div wire:key="{{$brand->id}}" class="bg-white rounded-lg shadow-md dark:bg-gray-800">
            <a href="/products?selected_brands[0]={{$brand->id}}" class="">
              <div class=" flex-1 flex-col flex">
                <img src="{{ url('storage', $brand->image) }}" alt="{{$brand->name}}" class="object-cover w-full h-full rounded-t-lg">
              </div>
            </a>
    ...
    <section class="py-20 bg-gray-100 dark:bg-gray-800">
      <div class="max-w-xl mx-auto">
        <div class="text-center ">
          <div class="relative flex flex-col items-center">
            <h1 class="text-5xl font-bold dark:text-gray-200">✨ On <span class="text-blue-500"> Sale✨
              </span> </h1>
            <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
              <div class="flex-1 h-2 bg-blue-200">
              </div>
      ...
      <div class="max-w-6xl px-4 py-4 mx-auto lg:py-0">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
          ...
          <div wire:key="{{$product->id}}" class="bg-white rounded-lg shadow-md dark:bg-gray-800">
            <a href="/products?selected_brands[0]={{$brand->id}}" class="h-[2.375rem] w-[2.375rem] rounded-full">
              <div class=" flex-1 flex-col flex">
                <img src="{{ url('storage', $product->image) }}" alt="{{$product->name}}" class="object-cover w-full h-full rounded-t-lg">
              </div>
            </a>
            <div class="p-5 text-center">
              <a href="" class="text-2xl font-bold tracking-tight text-gray-900 dark:text-gray-300">
              ...
              <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                <span class="font-bold text-blue-500">Price: </span> ${{$product->price}}
              </p>
            </div>
          </div>
          @endforeach
    ...
    <div class="bg-orange-200 py-20">
      <div class="max-w-xl mx-auto">
        <div class="text-center ">
          ...
          <p class="mb-12 text-base text-center text-gray-500">
            Checkout our vast collection of categories!
          </p>
        </div>
      </div>
